      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-white/50 text-sm leading-relaxed">
              Montacargas de litio y combustión, nuevos y usados, repuestos y
              servicio técnico especializado en toda Venezuela.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/50 text-sm">
              ...
              <li>Barcelona, Anzoátegui</li>
              <li>Lun - Vie: 7:30AM - 4:30PM</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-4">
            <a
              href="https://www.instagram.com/uniparts_andina/"
              target="_blank"
            ...
            <a
              href="https://www.facebook.com/upandina"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/30 hover:text-brand-orange transition-colors"
              aria-label="Facebook"
            ...
            <a
              href="https://www.linkedin.com/company/uniparts-andina/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/30 hover:text-brand-orange transition-colors"
              aria-label="LinkedIn"
